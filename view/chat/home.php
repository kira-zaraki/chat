            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card m-0">
                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-1 col1">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-2 col-sm-1 col1">
                            <div class="users-container">
                                ...
                                <ul class="users friend-list">
                                    <?php foreach ($friends as $friend): ?>
                                        <?php if ($friend->id != $user->id): ?>
                                            <li class="person friend" data-chat="person1">
                                                <div class="user">
                                                    <img src="https://www.bootdey.com/img/Content/avatar/avatar3.png" alt="Retail Admin">
                                                    <span class="status <?= $friend->status ?>"></span>
                                                </div>
                                                <p class="name-time">
                                                    <span class="name friend-name"><?php echo $friend->nom ?></span>
                                                    <span class="user_ref" style="display: none;"><?php echo $friend->id ?></span>
                                                </p>
                                            </li>
                                        <?php endif ?>
                                    <?php endforeach ?>
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-9 col-9">
                            <div class="selected-user">
                                <span>To: <span class="name box-name">Emily Russell</span></span>
                            </div>
                            <div class="chat-container">
                                <span class="scroll-to-old-message">OLD MESSAGE</span>
                                <ul class="chat-box chatContainerScroll">
                                    <h1 style="margin: 0 auto; width: fit-content;">choisir votre ami sur le gauche</h1>
                                    <!-- <li class="chat-left">
                                ...
                                <div class="form-group mt-3 mb-0">
                                    <textarea class="form-control send-text" rows="3" placeholder="Type your message here..."></textarea>
                                    <button class="send-button">SEND</button>
                                    <input type="hidden" value="<?php echo $user->id?>" name="sender" class="sender">
                                    <input type="hidden" value="" name="receiver" class="receiver">
                                </div>
                            </div>
                        </div>
                    </div>
